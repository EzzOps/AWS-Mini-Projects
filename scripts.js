...
function credentialExchange(googleToken) {
  ...
  if (googleTokenDecoded['sub']) {
    ...
    AWS.config.credentials = new AWS.CognitoIdentityCredentials({
      IdentityPoolId: 'us-east-1:7cbe1fda-03ea-4f45-8191-727a902633d3', // MAKE SURE YOU REPLACE THIS
      Logins: {
...
function accessImages() {
  ...
  var s3 = new AWS.S3();
  var params = {
    Bucket: "webidf-patchesprivatebucket-1fjc9yub12eh7" // MAKE SURE YOU REPLACE THIS
  }; 
